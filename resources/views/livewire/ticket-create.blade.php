            ...
            <div class="space-y-12">
              ...
              <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div class="sm:col-span-3">
                  ...
                  <input type="text" name="tenant" id="tenant" autocomplete="full-name" value="{{ auth()->user()->name }}"
                    class="block w-full rounded-md mt-2 border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-rp-600 sm:text-sm sm:leading-6">
                ...
                <div class="sm:col-span-2">
                  ...
                  <select name="building" id="building"
                    class="block w-full mt-2 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-rp-600 sm:text-sm sm:leading-6">
                ...
                <div class="sm:col-span-1">
                  ...
                  <div
                    class="flex mt-2 rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-rp-600 sm:max-w-md">
                ...
                <div class="sm:col-span-3">
                  ...
                  <select id="topic" name="topic"
                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset mt-2 ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-rp-600 sm:text-sm sm:leading-6">
                ...
                <div class="sm:col-span-full">
                  ...
                  <textarea id="details" name="details" type="details" rows="10" autocomplete="details"
                    class="block w-full rounded-md mt-2 border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-rp-600 sm:text-sm sm:leading-6" value="{{ old('details')}}">{{ old('details') }}</textarea>
              ...
              <div class="mt-6 flex items-center justify-end gap-x-6">
                ...
                <button wire:submit="store"
                  class="rounded-md bg-rp-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-rp-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rp-600">{{__("Save")}}</button>
              </div>
          </form>
        </div>
      </div>
